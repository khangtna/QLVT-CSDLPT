...
namespace qlvt_v2
{
    static class Program
    {
        ...
        public static String connstr_pulisher = "Data Source=ADMIN\\TRANKHANG;Initial Catalog=QLVT_UDPT;User ID=sa;Password=sa";

        public static SqlDataAdapter da;
        public static SqlDataReader myReader;
        public static String servername = "";
        public static String serverNameLeft = "";
        public static String servername1 = "ADMIN\\MSSQLSERVER01";
        public static String servername2 = "ADMIN\\MSSQLSERVER02";
        public static String username;
        public static String password;
        public static String database = "QLVT_UDPT";
